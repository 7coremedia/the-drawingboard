    ...
    <section className={cn("container mx-auto py-16", className)}>
      ...
      <div className={cn(
        ...
        <div className="text-left mb-6">
          <h2 className="font-display text-2xl md:text-3xl font-medium text-black mb-2">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <NavLink to="/contact">
                <Button
                  type="button"
                  className="border-0 rounded-2xl px-6 py-2 hover:opacity-90 transition-all font-black text-white"
                  style={{ backgroundColor: '#0b00ff', fontFamily: 'Satoshi Variable' }}
                >
                  Contact Us
                </Button>
              </NavLink>
            ...
            <div className="w-full sm:w-auto flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <Button
                  ...
                  className="border-0 rounded-2xl px-4 py-2 hover:opacity-90 transition-all font-black text-white flex items-center gap-2"
                  style={{ backgroundColor: '#0b00ff', fontFamily: 'Satoshi Variable' }}
                >
                  <img
