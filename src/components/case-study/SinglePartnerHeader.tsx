      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-[11px] font-black tracking-tighter text-[#0D0D0D] leading-none mb-1 uppercase">{partnerName}</span>
            <div className="flex items-center gap-2">
                <span className="text-[8px] font-bold text-black/30 uppercase tracking-widest">{partnerType}</span>
